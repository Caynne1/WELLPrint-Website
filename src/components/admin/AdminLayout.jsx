    ...
    <div className="flex h-screen overflow-hidden" style={{ background: isLight ? '#F4F7FB' : '#03112a' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        >
          ...
          {/* Right: theme toggle + homepage + username */}
          <div className="flex items-center gap-2">
            {/* Theme toggle — shows CURRENT mode, click to switch */}
            <button
              onClick={toggleTheme}
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = isLight ? 'rgba(25,147,210,0.40)' : 'rgba(25,147,210,0.40)'
